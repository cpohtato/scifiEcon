...
DICT_INPUTS = {
    FIRM_ENERGY: [MKT_LABOUR],
    FIRM_FOOD: [MKT_LABOUR],
    FIRM_PLASTICS: [MKT_LABOUR],
    FIRM_CONSUMER: [MKT_LABOUR, MKT_PLASTICS]
}
